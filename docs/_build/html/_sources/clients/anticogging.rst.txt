...
.. code-block:: python
    ...
    vertiq = vertiq2306(com, 0, firmware="servo")
...
+--------+---------------+----------------+-----------+----------------+-----------------------------------------------------------------------------------------------------------+
| 1      | is_data_valid | get            | uint8     | bool           | Indicates if the cog information is valid.  is_enabled must be called first to check the cog information. |
+--------+---------------+----------------+-----------+----------------+-----------------------------------------------------------------------------------------------------------+
| 2      | is_enabled    | get, set, save | uint8     | bool           | Indicates if anticogging is running.  This will stay 0/false if the is_data_valid field is 0/false.       |
+--------+---------------+----------------+-----------+----------------+-----------------------------------------------------------------------------------------------------------+
