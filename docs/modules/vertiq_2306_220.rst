***********************************
Vertiq 2306 220KV | Position Module
***********************************

.. sidebar:: Vertiq 2306 220KV

    .. image:: ../_static/IQ2306_220kv.png
        :alt: Vertiq 2306 200KV
    

The Vertiq 2306 220KV is an integrated motor
...
the user. The Vertiq 2306 Position Module has a built-in
...
.. note:: 
    ...
    While the default firmware for the Vertiq 2306 220KV is the Servo Firmware, it also fully supports the following:
