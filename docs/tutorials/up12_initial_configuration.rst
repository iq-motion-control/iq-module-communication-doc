...
Once the firmware is flashed, connect the module to IQ Control Center and go to the ‘General’ tab. Download the :download:`UP12 Custom Defaults File<../_static/defaults_files/custom_defaults_pulsing_12x4.json>`. Use the ‘Import’ button to load the defaults file into IQ Control Center.
