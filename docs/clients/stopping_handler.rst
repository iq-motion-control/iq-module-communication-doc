...
+========+===============+================+===========+=========+============================================================================================+
| 0      | stopped_speed | get, set, save | float     | "rad/s" | The speed at which the module needs to spin at or below to be considered stopped.          |
+--------+---------------+----------------+-----------+---------+--------------------------------------------------------------------------------------------+
| 1      | stopped_time  | get, set, save | float     | "s"     | The amount of time the module needs to spin at its stopped_speed to be considered stopped. |
+--------+---------------+----------------+-----------+---------+--------------------------------------------------------------------------------------------+
