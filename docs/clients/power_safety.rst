...
+========+=======================+================+===========+=========+====================================================================================================================================================================================================================================================+
| 0      | fault_now             | get            | uint8     | Bitmask | The fault(s) that are currently triggering                                                                                                                                                                                                         |
+--------+-----------------------+----------------+-----------+---------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1      | fault_ever            | get, set, save | uint8     | Bitmask | Record of all faults that were triggered since last modified by user. The user can clear all of the records by setting the value to 0, or individual faults by properly setting bitmask value                                                      |
+--------+-----------------------+----------------+-----------+---------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2      | fault_latching        | get, set, save | uint8     | Bitmask | Determines if the motor is latching. When latching, if there are any bits set in fault_ever, motor will stay in Safe Mode until they are cleared. When not latching, motor will enter and exit Safe Mode only on current faults based on fault_now |
+--------+-----------------------+----------------+-----------+---------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
