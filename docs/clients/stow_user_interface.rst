...
Type ID 85 | Stow User Interface
    .. table:: Stow User Interface
        ...
        +--------+---------------------+-----------------+-----------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        || 8     || hold_stow          || get, set, save || uint8    ||                                          || Determines what the module will do when it reaches its stow position at the end of a stow.                                                                                                     |
        ||       ||                    ||                ||          ||                                          || 0 = Coast When Stowed: Module will coast.                                                                                                                                                      |
        ||       ||                    ||                ||          ||                                          || 1 = Hold Stow Angle: Module will actively try to hold its stow position.                                                                                                                       |
        ||       ||                    ||                ||          ||                                          || 2 = Brake When Stowed: Module will brake.                                                                                                                                                      |
        ||       ||                    ||                ||          ||                                          || 3 = Low Power Hold: Module will transition between braking and actively holding its stow position to attempt to reduce power consumption. See :ref:`low_power_hold` for more details           |
        +--------+---------------------+-----------------+-----------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        ...
        ||       ||                    ||                ||          ||                                          || 2 = Holding: The module is actively holding its stow postion.                                                                                                                                  |
        +--------+---------------------+-----------------+-----------+-------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
