...
Type ID 104 | Throttle Source Manager
    .. table:: Throttle Source Manager
        ...
        +========+========================+================+===========+=================================+===================================================================================================================================================================================================+
        | 0      | throttle_timeout       | get, set, save | float     | Seconds                         | Defines the amount of time, in seconds, that the Throttle Source Manager will wait for a new message from the highest received priority before checking the next lowest priority throttle source. |
        +--------+------------------------+----------------+-----------+---------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        ...
        +--------+------------------------+----------------+-----------+---------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 4      | active_throttle_source | get            | uint8     |                                 | Reports the throttle source type currently controlling the module. 0: No active source, 1: Timer Based Protocol, 2: DroneCAN, 3: IQUART                                                           |
        +--------+------------------------+----------------+-----------+---------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+