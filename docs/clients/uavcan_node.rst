...
Type ID 80 | UAVCAN Node
    .. table:: UAVCAN Node
        ...
        +--------+------------------------+----------------+-----------+---------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 12     | arming_by_arming_status| get, set, save | uint8     | :math:`\text{Bool}`             | This setting allows the module to arm and disarm based on the DroneCAN ArmingStatus message. Flight controllers are responsible for transmitting the ArmingStatus message, the module is a listener only.                                                                                                                              |
        +--------+------------------------+----------------+-----------+---------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+