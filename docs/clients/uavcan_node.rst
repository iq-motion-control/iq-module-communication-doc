...
Type ID 80 | UAVCAN Node
    .. table:: UAVCAN Node
        ...
        +--------+-------------------------+----------------+-----------+---------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 13     | telemetry_style         | get, set, save | uint8     | :math:`\text{Bool}`             | Setting this to 0 will output the ESC Status and ESC Status Extended as telemetry. Setting this to 1 will outputs the ESC Status and Device Temperature as telemetry.                                                                                                                                                                                                                                           |
        +--------+-------------------------+----------------+-----------+---------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+