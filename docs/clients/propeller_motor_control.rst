...
Type ID 52 | Propeller Motor Controller
    .. table:: Propeller Motor Controller
        ...
        +--------+---------------------+----------------+-----------+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 17     | timeout_meaning     | get, set, save | uint8     | :math:`\text{Enum}`                        | This indicates if a timeout is intended to be used as an intentional disarm or as an error (as well as whether to disarm on an error). 0 \= Timeout Error Disarm, 1 \= Disarm, 2 \= Timeout Error Disarm          |   
        +--------+---------------------+----------------+-----------+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
