...
+--------+---------------------+----------------+-----------+------------+---------------------------------------------------------------------------------------------+
| 17     | timeout_meaning     | get, set, save | uint8     | enum       | This indicates if a timeout is intended to be used as an intentional disarm or as an error. |
+--------+---------------------+----------------+-----------+------------+---------------------------------------------------------------------------------------------+
| 18     | timeout_behavior    | get, set, save | uint8     | enum       | This detemines what behavior to perform when a timeout error occurs.                        |
+--------+---------------------+----------------+-----------+------------+---------------------------------------------------------------------------------------------+
| 19     | timeout_song_option | get, set, save | uint8     | enum       | This determines how many times the timeout song will play on a timeout error.               |
+--------+---------------------+----------------+-----------+------------+---------------------------------------------------------------------------------------------+
