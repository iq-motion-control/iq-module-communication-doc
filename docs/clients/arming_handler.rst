...
Type ID 86 | Arming Handler
    .. table:: Arming Handler
        ...
        ||       ||                                       ||                ||          ||                         || 3 = Stow: The module will trigger a move to the stow postiion when it begins disarming. After the song, its final state will be determined by whatever the stow position feature is configured to do after completing a stow.                       |
        +--------+----------------------------------------+-----------------+-----------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        ...
        +--------+----------------------------------------+-----------------+-----------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        || 11    || manual_arming_throttle_source         || get, set, save || uint8    ||                         || This client is only available on speed modules with firmware versions before v0.1.0.                                                                                                                                                                |
        ||       ||                                       ||                ||          ||                         || The :ref:`throttle source <throttle_sources>` used as its armed throttle source for manual arming. The default manual throttle source is Unknown. In order to use manual arming, a throttle source must be set first. See row below for each state: |
        ...
        ||       ||                                       ||                ||          ||                         || 1 = :ref:`Hobby <timer_based_protocol>`                                                                                                                                                                                                             |
        ||       ||                                       ||                ||          ||                         || 2 = :ref:`DroneCAN <dronecan_protocol>`                                                                                                                                                                                                             |
        ||       ||                                       ||                ||          ||                         || 3 = :ref:`IQUART <uart_messaging>`                                                                                                                                                                                                                  |
        +--------+----------------------------------------+-----------------+-----------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 12     | motor_armed                            | get, set        | uint8     |                          | Returns True if motor is armed.                                                                                                                                                                                                                      |
        +--------+----------------------------------------+-----------------+-----------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 13     | consecutive_arming_throttles_to_disarm | get, set, save  | uint32    | :math:`\text{throttles}` | Number of consecutive throttles before disarming.                                                                                                                                                                                                    |
        +--------+----------------------------------------+-----------------+-----------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 14     | play_arming_song_on_arm                | get, set, save  | uint8     |                          | If true, the motor will play its :ref:`arming song <arming_song>` on arming. If false, it will not play the song on arming.                                                                                                                          |
        +--------+----------------------------------------+-----------------+-----------+--------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+