...
Type ID 89 | Pulsing Rectangular Input Parser
    .. table:: Pulsing Rectangular Input Parser
        ...
        +========+=======================+================+===========+===============================+==============================================================================================================================================================================================================================+
        | 0      | pulsing_scaling_mode  | get, set, save | uint8     | :math:`\text{Enum}`           | 0 = Supply Voltage Mode (voltage pulsing only), 1 = Scaling Limit Mode. Note that when using velocity based pulsing firmware, ``pulsing_scaling_mode`` is set to ``Scaling Limit Mode`` by default, and cannot be changed.   |
        +--------+-----------------------+----------------+-----------+-------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 1      | pulsing_scaling_limit | get, set, save | float     | :math:`V` or :math:`rad/s`    | This sets the max pulsing limit (voltage or velocity) when in Scaling Limit Mode. Units are volts when using voltage based pulsing and rad/s when using velocity based pulsing.                                              |
        +--------+-----------------------+----------------+-----------+-------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+