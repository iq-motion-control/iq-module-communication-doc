...
Type ID 100 | RGB LED Interface
    .. table:: RGB LED Interface
        ...
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 5      | strobe_period | get, set, save | float     |   :math:`\text{s}`  | The amount of time, in seconds, it takes to complete the strobe pattern                                                                                                             |
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 6      | strobe_pattern| get, set, save | uint32    |                     | A 32-bit bitmask that represents the :ref:`strobing pattern <strobing_pattern>`. A 1 means the LED is on for the duration of that segment :math:`\frac{\text{strobe_period}}{32}`   |
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
