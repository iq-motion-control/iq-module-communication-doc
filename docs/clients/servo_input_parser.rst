...
+========+============+================+===========+========+==================================================+
| 0      | mode       | get, set, save | uint8     | enum   | 0 = PWM, 1 = Voltage, 2 = Velocity, 3 = Position |
+--------+------------+----------------+-----------+--------+--------------------------------------------------+
| 1      | unit_min   | get, set, save | float     | (mode) | Minimum value.  Unit determined by mode.         |
+--------+------------+----------------+-----------+--------+--------------------------------------------------+
| 2      | unit_max   | get, set, save | float     | (mode) | Maximum value.  Unit determined by mode.         |
+--------+------------+----------------+-----------+--------+--------------------------------------------------+
