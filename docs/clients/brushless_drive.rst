...
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 10     | mech_lead_angle               | get            | float     | rad      |Lag compensation used                                                                                                                 |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
...
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 14     | motor_pole_pairs              | get, set, save | uint16    | PP       | Number of motor pole pairs (magnets/2)                                                                                               |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 15     | motor_emf_shape               | get, set, save | uint8     |          |Default is sinusoidal EMF.  Some firmwares have trapezoidal or custom shapes.                                                         |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 16     | permute_wires                 | get, set, save | uint8     | bool     |Factory set.  Do not change.                                                                                                          |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 17     | calibration_angle             | get, set, save | float     | rad      |Factory set.  Do not change.                                                                                                          |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 18     | lead_time                     | get, set, save | float     | s        |Factory set.  Do not change.                                                                                                          |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
...
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 21     | drive_volts_addition          | get, set       | float     | V        |Amount of voltage applied for anticogging or buzzing                                                                                  |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 22     | angle_adjust_enable           | get, set, save | uint8     | bool     |Enables closed loop timing angle adjustment                                                                                           |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 23     | motor_emf_calc                | get            | float     | V        |Computed emf from closed loop angle calculation                                                                                       |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 24     | angle_adjustment              | get            | float     | rad      |Angle adjustment from closed loop calculation                                                                                         |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 25     | angle_adjust_max              | get, set, save | float     | rad      |Maximum angle the closed loop calculation is allowed to adjust                                                                        |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 26     | angle_adjust_kp               | get, set, save | float     |          |Proportional gain for angle adjustment                                                                                                |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 27     | angle_adjust_ki               | get, set, save | float     |          |Integral gain for angle adjustment                                                                                                    |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
...
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 44     | emf                           | get            | float     | V        |Reports estimated back-EMF voltage produced by the motor, based on its velocity                                                       |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 45     | volts_at_max_amps             | get            | float     | V        |Model based voltage at maximum allowed motor amps                                                                                     |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 46     | slew_volts_per_second         | get, set, save | float     | V/s      |The drive voltage that is expected to be applied at the motor's maximum safe current, based on motor resistance. Used to limit the maximum current applied to the motor.                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 47     | slew_enable                   | get, set, save | float     | V        |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 48     | motoring_supply_current_limit | get, set, save | float     | fix16_t  |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 49     | regen_supply_current_limit    | get, set, save | float     | fix16_t  |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 50     | supply_current_limit_enable   | get, set, save | uint8     | bool     |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 51     | regen_limiting                | get            | uint8     | bool     |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 52     | regen_limit_adjust            | get            | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 53     | motoring_limiting             | get            | uint8     | bool     |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 54     | motoring_limit_adjust         | get            | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 55     | regen_limit_kp                | get, set, save | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 56     | regen_limit_ki                | get, set, save | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 57     | regen_limit_max               | get, set, save | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 58     | motoring_limit_kp             | get, set, save | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 59     | motoring_limit_ki             | get, set, save | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
| 60     | motoring_limit_max            | get, set, save | float     |          |                                                                                                                                      |      |
+--------+-------------------------------+----------------+-----------+----------+--------------------------------------------------------------------------------------------------------------------------------------+------+
