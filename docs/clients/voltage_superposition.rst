...
+========+===============================+================+===========+===============+=========================================================================================================================================================================================+
| 0      | zero_angle                    | get, set, save | float     | 1/s (rad)     | The anglular position that the module considers as its 'zero' position to start pulsing.                                                                                                |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1      | frequency                     | get, set, save | uint8     | Hz            | The number of pulses that happen per rotation.                                                                                                                                          |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2      | phase                         | get, set       | float     | 1/s (rad)     | This value is added to the zero angle to set where the pulse occurs.                                                                                                                    |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3      | amplitude                     | get, set       | float     | V             | This value represents the strength of the pulse. Setting the amplitude too high at lower speeds can cause the pulsing to overcome the inertia of the motor spinning, causing it to stop |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4      | voltage                       | get            | float     | V             | The voltage that is currently being applied by the pulsing client.                                                                                                                      |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5      | max_allowed_amplitude         | get            | float     | V             | The maximum pulsing amplitude based on settings and velocity.                                                                                                                           |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6      | velocity_cutoff               | get, set, save | float     | rad/s         | The velocity at which pulsing is allowed. Any velocity between cutoff and \-cutoff will not pulse.                                                                                      |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 7      | poly_coeff_zero               | get, set, save | float     | V             | The zeroth coefficient of the cutoff polynomial.                                                                                                                                        |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 8      | poly_coeff_one                | get, set, save | float     | V * (s/rad)   | The first coefficient of the cutoff polynomial.                                                                                                                                         |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 9      | poly_coeff_two                | get, set, save | float     | V * (s/rad)^2 | The second coefficient of the cutoff polynomial.                                                                                                                                        |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 10     | poly_coeff_three              | get, set, save | float     | V * (s/rad)^3 | The third coefficient of the cutoff polynomial.                                                                                                                                         |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 11     | phase_lead_time               | get, set, save | float     |               | The phase lead time setting for tuning pulsing propellers.                                                                                                                              |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 12     | phase_lead_angle              | get            | float     | rad           | The instantaneous phase lead angle determined by the phase lead time.                                                                                                                   |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 13     | phase_act                     | get            | float     | rad           | The instantaneous phase being used by the pulsing client.                                                                                                                               |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 14     | amplitude_act                 | get            | float     | V             | The instantaneous amplitude being used by the pulsing client.                                                                                                                           |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 15     | sample_mechanical_zero        | set            |           |               | Sets the zero_angle to the current motor position.                                                                                                                                      |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 16     | propeller_torque_offset_angle | get, set, save | float     | rad           | This offsets where the pulse starts around the motor to allow for propeller mechanical properties.                                                                                      |
+--------+-------------------------------+----------------+-----------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
