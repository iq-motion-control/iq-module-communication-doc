...
+========+===============================+================+===========+===============+==========================================================================================================================================================================================+
| 0      | zero_angle                    | get, set, save | float     | 1/s (rad)     | This is the angular position that the module considers as its 'zero' position to start pulsing.                                                                                          |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1      | frequency                     | get, set, save | uint8     | Hz            | This is the number of pulses that happen per rotation.                                                                                                                                   |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4      | voltage                       | get            | float     | V             | This is the voltage that is currently being applied by the pulsing client.                                                                                                               |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5      | max_allowed_amplitude         | get            | float     | V             | This is the maximum pulsing amplitude based on settings and velocity.                                                                                                                    |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6      | velocity_cutoff               | get, set, save | float     | rad/s         | This is the velocity at which pulsing is allowed. Any velocity between cutoff and \-cutoff will not pulse.                                                                               |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 7      | poly_coeff_zero               | get, set, save | float     | V             | This is the zeroth coefficient of the cutoff polynomial.                                                                                                                                 |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 8      | poly_coeff_one                | get, set, save | float     | V * (s/rad)   | This is the first coefficient of the cutoff polynomial.                                                                                                                                  |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 9      | poly_coeff_two                | get, set, save | float     | V * (s/rad)^2 | This is the second coefficient of the cutoff polynomial.                                                                                                                                 |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 10     | poly_coeff_three              | get, set, save | float     | V * (s/rad)^3 | This is the third coefficient of the cutoff polynomial.                                                                                                                                  |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 11     | phase_lead_time               | get, set, save | float     |               | This is the phase lead time setting for tuning pulsing propellers.                                                                                                                       |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 12     | phase_lead_angle              | get            | float     | rad           | This is the instantaneous phase lead angle determined by the phase lead time.                                                                                                            |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 13     | phase_act                     | get            | float     | rad           | This is the instantaneous phase being used by the pulsing client.                                                                                                                        |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 14     | amplitude_act                 | get            | float     | V             | This is the instantaneous amplitude being used by the pulsing client.                                                                                                                    |
+--------+-------------------------------+----------------+-----------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
