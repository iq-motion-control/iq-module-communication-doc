...
+========+===============================+================+===========+===============+======+
| 0      | zero_angle                    | get, set, save | float     | rad           |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 1      | frequency                     | get, set, save | uint8     | 1/rev         |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 2      | phase                         | get, set       | float     | rad           |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 3      | amplitude                     | get, set       | float     | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 4      | voltage                       | get            | float     | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 5      | max_allowed_amplitude         | get            | float     | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 6      | velocity_cutoff               | get, set, save | float     | rad/s         |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 7      | poly_coeff_zero               | get, set, save | float     | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 8      | poly_coeff_one                | get, set, save | float     | V * (s/rad)   |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 9      | poly_coeff_two                | get, set, save | float     | V * (s/rad)^2 |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 10     | poly_coeff_three              | get, set, save | float     | V * (s/rad)^3 |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 11     | phase_lead_time               | get, set, save | float     |               |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 12     | phase_lead_angle              | get            | float     | rad           |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 13     | phase_act                     | get            | float     | rad           |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 14     | amplitude_act                 | get            | float     | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 15     | sample_mechanical_zero        | set            |           | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
| 16     | propeller_torque_offset_angle | get, set, save | float     | V             |      |
+--------+-------------------------------+----------------+-----------+---------------+------+
