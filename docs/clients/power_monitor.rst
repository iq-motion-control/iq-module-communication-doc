...
Type ID 69 | Power Monitor
    .. table:: Power Monitor
        ...
        +--------+--------------------------+----------------+-----------+-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 13     | volts_cascaded           | get, set, save | float     | :math:`\text{V}`      | This is the voltage reading after cascading it through a second filter. This is used for specific applications in the firmware that require an additionally filtered voltage reading. |
        +--------+--------------------------+----------------+-----------+-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 14     | volts_cascaded_filter_fc | get, set, save | uint32    | :math:`\text{Hz}`     | This is the low pass filter cutoff frequency applied to volts cascaded.                                                                                                               |
        +--------+--------------------------+----------------+-----------+-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
