...
Type ID 101 | White LED Interface
    .. table:: White LED Interface
        ...
        +========+===============+================+===========+=====================+=====================================================================================================================================================================================+
        | 0      | intensity     | get, set, save | uint8     |   %                 | The intensity of the white LEDs as a percentage [0, 100]%. If saved, this is the white intensity that is used on boot                                                               |
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        ...
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 2      | strobe_period | get, set, save | float     |   s                 | The amount of time, in seconds, it takes to complete the strobe pattern                                                                                                             |
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
        | 3      | strobe_pattern| get, set, save | uint32    |                     | A 32-bit bitmask that represents the :ref:`strobing pattern <strobing_pattern>`. A 1 means the LED is on for the duration of that segment :math:`\frac{\text{strobe_period}}{32}`   |
        +--------+---------------+----------------+-----------+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
