...
Type ID 59 | Multi-turn Angle Controller
	.. table:: Multi-turn Angle Controller
		...
		+--------+-------------------------------------+----------------+-----------+-------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
		| 32     | additional_velocity                 | get, set, save | float     | :math:`\frac{\text{rad}}{s}`              | This is an additional velocity that is added to the normal velocity controller target. This is used within the firmware by pulsing modules, so generally you should not need to set to or get from this endpoint.                                                                                                                                  |
		+--------+-------------------------------------+----------------+-----------+-------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
		| 33     | low_power_hold_allowed_target_error | get, set, save | float     | :math:`\text{rad}`                        | The allowed target error (how close you must get to the target before transitioning to brake) when using a low power angle hold.                                                                                                                                                                                                                   |
		+--------+-------------------------------------+----------------+-----------+-------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
		| 34     | low_power_hold_max_brake_error      | get, set, save | float     | :math:`\text{rad}`                        | The allowed brake error (how far you must get from the target before transitioning to actively holding the position) when using a low power angle hold.                                                                                                                                                                                            |
		+--------+-------------------------------------+----------------+-----------+-------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
		| 35     | ctrl_angle_low_power                | set            | float     | :math:`\text{rad}`                        | Command a low power hold at a specified angle.                                                                                                                                                                                                                                                                                                     |
		+--------+-------------------------------------+----------------+-----------+-------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
		| 36     |trajectory_queue_length              | get            | uint8     |                                           | The current length of the trajectory queue. Increases as trajectories are appended to the queue, decreases as trajectories complete or are overwritten.                                                                                                                                                                                            |
		+--------+-------------------------------------+----------------+-----------+-------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
