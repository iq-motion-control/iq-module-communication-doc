...
* **Communication**: This parameter is available through the General tab, and defines the communication protocol expected by your module as sent by the 
  flight controller when using :ref:`hobby protocols <timer_based_protocol>`. This parameter can be Standard PWM, OneShot protocols, MultiShot, or DShot protocols. Please note that if you are 
