...
.. note::
    ...
    integration. For example, refer to the `PX4 documentation <https://docs.px4.io/main/en/flight_controller/>`_ config_values for integrating with a PX4 flight controller. 
