...
depends on the configurations of the module. Refer to the :red:`Mapping to Throttle` section for more details on that mapping in speed modules and 
the :red:`Throttle Definition` section for more details on how a throttle command is defined by speed modules.
...
more details on that mapping in speed modules and the :red:`Throttle Definition` section for more details on how a throttle command is defined by speed modules.
...
this number into a throttle command depends on the configurations of the module. Refer to the :red:`Mapping to Throttle` section for more details on that mapping for speed modules and 
the :red:`Throttle Definition` section for more details on how a speed module defines a throttle command.
...
Arming
========
Hobby Protocols use the same advanced arming procedure as all other throttle sources on speed modules. The details of this arming procedure are covered in the :red:`Advanced Arming` section.